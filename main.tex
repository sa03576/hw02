...
\title{Habib University\\CS 113 Discrete Mathematics\\Spring 2018}
...
\begin{parts}
  \part[20] For each suspect, write their testimony in the form of well-defined propositions, using quantifiers wherever possible, in addition to negations, disjunctions and conjunctions. You may use the following statements to construct your propositions:
  ...
  \part[10] Use your propositions to fill in the following table.
